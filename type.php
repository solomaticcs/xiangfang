...
if($tid2 != null)
{
	...
	$select_cart_type_tid_2 = $db->db_query($select_cart_type_tid_1);
	$select_cart_type_tid_3 = $db->db_fetch($select_cart_type_tid_2);
}
?>
<!doctype html>
				...
				<table>
					...
					<td class="my_content">
						...
						if($tid2 != null && $tid2 == $select_cart_type_tid_3[0] && $offset >= 0 && $page<=$pagenum)
						{
							...
							$select_cart_type_product_2 = $db->db_query($select_cart_type_product_1);
							while($select_cart_type_product_3 = $db->db_fetch($select_cart_type_product_2))
							{ //列出所有的物品清單
								$sum=$sum+1;
								if($sum > $num)
								{
